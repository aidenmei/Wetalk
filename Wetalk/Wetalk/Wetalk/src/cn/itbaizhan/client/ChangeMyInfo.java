...
public class ChangeMyInfo extends JDialog{
	...
	JLabel jLmyName=new JLabel("I am Chris");
	JLabel jLmyNum=new JLabel("593253716");
	JLabel jLmySign=new JLabel("How are you doing ");
	JLabel jLmyother=new JLabel("Female   20   New York");
	...
	JLabel jLsign=new JLabel("What's up£º");
	JTextArea jTsign=new JTextArea("how are you ");
	JLabel jLName=new JLabel("Nickname£º");
	JTextField jTname=new JTextField("I am Chris");
	JLabel jLenglishName=new JLabel("English£º");
	JTextField jTenglishName=new JTextField("Sweety");
	JLabel jLsex=new JLabel("Gender£º");
	String sex[]={"Male","Female"};
	JComboBox jTsex=new JComboBox(sex);
	JLabel jLblood=new JLabel("Blood type£º");
	String blood[]={"A","B","AB","O","other"};
	JComboBox jTblood=new JComboBox(blood);
	JLabel jLbirth=new JLabel("Birthday£º");
	String timeT[]={"Gregorian calendar", "lunar calendar"};
    ...
    JLabel jLaddress=new JLabel("Country£º");
    JTextField jTaddress=new JTextField("NY New York");
    JLabel jLplace=new JLabel("Address£º");
    JTextField jTplace=new JTextField("NY New York");
	 BufferedReader in;
	 PrintStream out;
	...
	public void init()
	{
		...
		jLmyName.setFont(new Font("Times New Roman",Font.BOLD,24));
		jLmyName.setBounds(80, 25, 150, 25);
		jLmyNum.setForeground(Color.WHITE);
		jLmyNum.setFont(new Font("Times New Roman",Font.PLAIN,18));
		...
		jLmyother.setFont(new Font("Times New Roman",Font.PLAIN,14));
		...
		jBsave.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					{
						ChangeMyInfo.this.setVisible(false);
						JOptionPane.showConfirmDialog(father, "The system is busy, please try again later£¡");
		...
		jLsign.setFont(new Font("Times New Roman",Font.PLAIN,14));
		jLsign.setBounds(10, 165, 100, 25);
		jTsign.setFont(new Font("Times New Roman",Font.PLAIN,14));
		...
		jyear.setFont(new Font("Times New Roman",Font.PLAIN,14));
		...
		jmonth.setFont(new Font("Times New Roman",Font.PLAIN,14));
